...
public class EntityRegistry implements IEntityRegistry {
    ...
    public EntityRegistry(NMSUtils nmsUtils) {
        this.nmsUtils = nmsUtils;
    }

    public void registerEntities() {
        ALPHA_WOLF = injectNewEntity("alpha_wolf", "wolf", (entityTypes, world) -> new WolfAlpha_1_16_R3((EntityTypes<? extends EntityWolf>) entityTypes, world, nmsUtils), EnumCreatureType.CREATURE);
    }
